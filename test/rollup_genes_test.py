...
class GeneRollupTestCase(unittest.TestCase):
    def test_create_df(self):
        input_string =\
'''#CHROM\tPOS\tREF\tALT\tGENE_SYMBOL\tdbNSFP_rollup_damaging\tSNPEFF_TOP_EFFECT_IMPACT\tJQ_CONS_SOM
1\t2\t3\t4\t5\t6\t7\t8'''
        actual_df = rollup_genes._create_df(StringIO(input_string))
        self.assertEquals(["#CHROM", "POS", "REF", "ALT", "GENE_SYMBOL", "dbNSFP_rollup_damaging", "SNPEFF_TOP_EFFECT_IMPACT", "JQ_CONS_SOM"],
...
1\t2\t3\t4\t5\t6\t7'''
    ...
    def test_remove_unnecessary_columns(self):
        input_string =\
'''#CHROM|POS|REF|ALT|GENE_SYMBOL|dbNSFP_rollup_damaging|JQ_CONS_SOM_A|JQ_CONS_SOM_B|FOO|BAR
1|2|3|4|5|6'''
        input_df = dataframe(input_string)

        actual_df = rollup_genes._remove_unnecessary_columns(input_df)
        self.assertEquals(["#CHROM", "POS", "REF", "ALT", "GENE_SYMBOL", "dbNSFP_rollup_damaging", "JQ_CONS_SOM_A", "JQ_CONS_SOM_B"],
                          list(actual_df.columns.values))
...
class dbNSFPTestCase(unittest.TestCase):
    def test_melt_df(self):
        input_string =\
'''#CHROM|POS|REF|ALT|GENE_SYMBOL|dbNSFP_rollup_damaging|SNPEFF_TOP_EFFECT_IMPACT|JQ_CONS_SOM_A|JQ_CONS_SOM_B
1|2|3|4|BRCA1|4|.|2|3
1|2|3|4|BRCA1|5|.|3|4'''
        input_df = dataframe(input_string)
        ...
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "4", "JQ_CONS_SOM_A", "2"], list(actual_df.values[0]))
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "5", "JQ_CONS_SOM_A", "3"], list(actual_df.values[1]))
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "4", "JQ_CONS_SOM_B", "3"], list(actual_df.values[2]))
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "5", "JQ_CONS_SOM_B", "4"], list(actual_df.values[3]))
...
1|2|3|4|BRCA1|5|.|3|4'''
        ...
        actual_df = dbNSFP.melt_df(input_df)
        print actual_df
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "5", "JQ_CONS_SOM_A", "3"], list(actual_df.values[0]))
        self.assertEquals([".", "2", "BRCA1", "1", "4", "3", "5", "JQ_CONS_SOM_B", "4"], list(actual_df.values[1]))

    def calculate_total_samples(self):
        input_string =\
'''#CHROM|POS|REF|ALT|GENE_SYMBOL|dbNSFP_rollup_damaging|Sample|Sample_Data
1|12|A|G|BRCA1|3|JQ_CONS_SOM_A|0
1|23|A|G|BRCA1|3|JQ_CONS_SOM_B|.
1|42|A|G|CREBBP|3|JQ_CONS_SOM_A|0
1|42|A|G|CREBBP|2|JQ_CONS_SOM_B|1'''
        input_df = dataframe(input_string)
        dbNSFP = rollup_genes.dbNSFP()
...
class SnpEffTestCase(unittest.TestCase):
    def test_melt_df(self):
        input_string =\
'''#CHROM|POS|REF|ALT|GENE_SYMBOL|dbNSFP_rollup_damaging|SNPEFF_TOP_EFFECT_IMPACT|JQ_CONS_SOM_A|JQ_CONS_SOM_B|total variants
...
1|2|3|4|BRCA1|.|LOW|3|4|.'''
        ...
        self.assertEquals(["HIGH", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_A", "2"], list(actual_df.values[0]))
        self.assertEquals(["LOW", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_A", "3"], list(actual_df.values[1]))
        self.assertEquals(["HIGH", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_B", "3"], list(actual_df.values[2]))
        self.assertEquals(["LOW", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_B", "4"], list(actual_df.values[3]))
...
1|2|3|4|BRCA1|.|HIGH|3|4|.'''
        ...
        self.assertEquals(["HIGH", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_A", "3"], list(actual_df.values[0]))
        self.assertEquals(["HIGH", "2", "BRCA1", "1", "4", "3", ".", "JQ_CONS_SOM_B", "4"], list(actual_df.values[1]))
...
BRCA1\tLOW\tJQ_CONS_SOM|P1|NORMAL\t2'''
    ...
    def test_rename_columns(self):
        input_string =\
'''#CHROM\tPOS\tREF\tALT\tGENE_SYMBOL\tdbNSFP_rollup_damaging\tSNPEFF_TOP_EFFECT_IMPACT\tJQ_CONS_SOM|P1|NORMAL\tJQ_CONS_SOM|P1|TUMOR\ttotal impacted samples
1\t2\t3\t4\tBRCA1\t.\tHIGH\t2\t3\t.
1\t2\t3\t4\tBRCA1\t.\tLOW\t3\t4\t.'''
        input_df = dataframe(input_string, sep="\t")
        SnpEff = rollup_genes.SnpEff()
